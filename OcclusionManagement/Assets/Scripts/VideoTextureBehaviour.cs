...
public class VideoTextureBehaviour : MonoBehaviour, IVideoBackgroundEventHandler
{
    ...
    private void PositionVideoMesh()
    {
        ...
        // Set the local scale so that the width is 1 and the height is adjusted according to the aspect ratio of the texture.
        // since the texture will be rotated by 90 degrees in portrait mode, this will be swapped in that case.
